...
(function (global) {
  ...
  global.TMApi = {
    ...
    changeSessionPdrTeacher: callStore('changeSessionPdrTeacher'),
    changeSessionBranchTeacher: callStore('changeSessionBranchTeacher'),
    markPdrTeacherInformed: callStore('markPdrTeacherInformed'),
    markBranchTeacherInformed: callStore('markBranchTeacherInformed'),
