...
/** Oturum süresi: Supabase JWT geçerliliği (≈1 saat); çerez tarayıcı oturumuna bağlı */
...
/** @param {string} name @param {string} value @param {number|null|undefined} maxAge — null/undefined = tarayıcı oturum çerezi (sekme/tarayıcı kapanınca silinir) */
...
/** Yalnızca access token — tarayıcı oturum çerezi; sekme kapanınca auth-tab-session.js ile temizlenir */
