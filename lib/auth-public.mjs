...
export function isPublicPath(pathname) {
  ...
  if (pathname.startsWith('/api/trial-manager/')) return true;
  if (pathname === '/sinav-sonuclari' || pathname === '/sinav-sonuclari.html') return true;
  if (pathname === '/seviye-belirleme' || pathname === '/seviye-belirleme.html') return true;
  if (pathname === '/dikkat-sinavi' || pathname === '/dikkat-sinavi.html') return true;
